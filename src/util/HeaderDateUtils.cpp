...
std::string HeaderDateUtils::getSyncDayReminderText() {
  // The upstream "SyncDay" reminder easter egg has no equivalent in this fork.
  return "";
}

void HeaderDateUtils::drawTopLine(const GfxRenderer& renderer, const std::string& dateText) {
